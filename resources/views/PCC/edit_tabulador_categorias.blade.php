...
<div class="container">
    ...
    --}}
    <form action="{{ route('tabulador_categorias.update' , $tabuladorCategoria) }}" method="POST">
    ...
    @enderror
        ...
        <div class="row">
            <div class="col-md-4 mb-3">
                <label for="nombre" class="form-label">Nueva Grupo:</label>
                <input type="text" class="form-control" id="grupo" name="grupo" required>
                <label for="nombre" class="form-label">Nueva Salario:</label>
                <input type="text" class="form-control" id="salario" name="salario" required>
                <label for="nombre" class="form-label">Nueva Bono Mes:</label>
                <input type="text" class="form-control" id="bono_mes" name="bono_mes" required>
                <label for="nombre" class="form-label">Nueva Bono Dia:</label>
