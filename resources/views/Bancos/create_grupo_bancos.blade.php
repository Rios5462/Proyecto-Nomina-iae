...
@section('content')
<div class="container">
    <h1>Modificando registro (Agregar Grupo Bancario)</h1>
    ...
    <form action="{{ route('grupo_bancos.store') }}" method="POST">
        @csrf
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control" id="codigo_banco_grupo" name="codigo_banco_grupo" value="{{ old('codigo_banco_grupo') }}" required>
            </div>
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="texto_inicial_carta" name="texto_inicial_carta" rows="4">{{ old('texto_inicial_carta') }}</textarea>
        </div>

        {{-- Texto Final Carta --}}
        <div class="mb-3">
            <label for="texto_final_carta" class="form-label">Texto Final Carta:</label>
            <textarea class="form-control" id="texto_final_carta" name="texto_final_carta" rows="4">{{ old('texto_final_carta') }}</textarea>
        </div>
