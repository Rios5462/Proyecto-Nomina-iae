...
<div class="container">
    {{-- Título de la vista --}}
    <h1 class="mb-4">Modificando registro (Nuevo Banco)</h1> 
    ...
    <form action="{{ route('bancos.store') }}" method="POST">
        ...
        <div class="row">
            ...
            <div class="col-md-3 mb-3">
                ...
                <input type="text" class="form-control" id="codigo_banco" name="codigo_banco" value="{{ old('codigo_banco') }}" required>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control" id="gerente" name="gerente" value="{{ old('gerente') }}">
            </div>
            ...
            <div class="col-md-4 mb-3">
                ...
                <div class="pt-2">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="tipo_cuenta" id="corriente" value="Corriente" {{ old('tipo_cuenta', 'Corriente') == 'Corriente' ? 'checked' : '' }}>
                        <label class="form-check-label" for="corriente">Corriente</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="tipo_cuenta" id="ahorro" value="Ahorro" {{ old('tipo_cuenta') == 'Ahorro' ? 'checked' : '' }}>
                        <label class="form-check-label" for="ahorro">Ahorro</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="tipo_cuenta" id="otra" value="Otra" {{ old('tipo_cuenta') == 'Otra' ? 'checked' : '' }}>
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="texto_inicial_carta" name="texto_inicial_carta" rows="6">{{ old('texto_inicial_carta') }}</textarea>
        </div>

        {{-- TEXTO FINAL CARTA (Textarea Grande) --}}
        <div class="mb-3">
            <label for="texto_final_carta" class="form-label">Texto Final Carta:</label>
            <textarea class="form-control" id="texto_final_carta" name="texto_final_carta" rows="6">{{ old('texto_final_carta') }}</textarea>
        </div>
